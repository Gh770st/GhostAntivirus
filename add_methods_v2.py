...
# Find the exact line to insert before calculate_file_hash
target_line = "/// Calculate SHA256 hash of file"
insert_point = content.find(target_line)

if insert_point != -1:
    # Insert new methods before calculate_file_hash
    new_methods = '''/// Extract features from file for AI analysis
    fn extract_file_features(&self, file_path: &Path, content: &[u8]) -> Result<ai::FileFeatures> {
        ...
        // Simple PE features for executables
    ...
    print("✅ Added extract_file_features and supporting methods")
else:
